		...
		implements GlobalEvents
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute("bs-drop-down-shown", STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 */
	@NotNull
	public BSDropDownShownDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSDropDownShownDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSDropDownShownDirective directive)
	{
