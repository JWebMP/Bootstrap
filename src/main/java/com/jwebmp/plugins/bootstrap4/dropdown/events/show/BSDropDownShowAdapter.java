 ...
 * @author GedMarc
 */
@ComponentInformation(name = "BS DropDown Show Event",
		...
		implements GlobalEvents
{
	...
	private static final java.util.logging.Logger LOG = LogFactory.getInstance()
	                                                              .getLogger("BSDropDownShowAdapter");
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().asAttributeBase().addAttribute("bs-drop-down-show", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	...
	public BSDropDownShowDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSDropDownShowDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSDropDownShowDirective directive)
	{
