...
public abstract class BSDropDownHideAdapter
		extends Event<GlobalFeatures,BSDropDownHideAdapter>
		implements GlobalEvents
{
	 ...
	 */
	private BSDropDownHideDirective directive;
	 ...
	 */
	public BSDropDownHideAdapter(Component component)
	{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().asAttributeBase().addAttribute("bs-drop-down-hide", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 */
	@NotNull
	public BSDropDownHideDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSDropDownHideDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSDropDownHideDirective directive)
	{
