		...
		implements GlobalEvents, BSAlertEvents
{
	...
	private static final Logger LOG = LogFactory.getInstance()
	                                            .getLogger("BSToastShowEvent");

	private BSToastShowEventDirective directive;
	 ...
	 */
	public BSToastShowEvent(Component component)
	{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			getComponent().addAttribute("ng-bs-toast-show-directive", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START_SHORT + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 * @return
	 */
	public BSToastShowEventDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSToastShowEventDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSToastShowEventDirective directive)
	{
