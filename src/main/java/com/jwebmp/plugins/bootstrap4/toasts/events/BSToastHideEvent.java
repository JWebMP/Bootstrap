		...
		implements GlobalEvents, BSAlertEvents
{
	...
	private static final Logger LOG = LogFactory.getInstance()
	                                            .getLogger("BSToastHideEvent");

	private BSToastHideEventDirective directive;
	 ...
	 */
	public BSToastHideEvent(Component component)
	{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			getComponent().addAttribute("ng-bs-toast-hide-directive", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START_SHORT + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 * @return
	 */
	public BSToastHideEventDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSToastHideEventDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSToastHideEventDirective directive)
	{
