		...
		implements GlobalEvents, BSAlertEvents
{
	 ...
	 */
	public BSToastShownEvent(Component component)
	{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			getComponent().addAttribute("ng-bs-toast-shown-directive", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START_SHORT + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	...
	public BSToastShownEventDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSToastShownEventDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSToastShownEventDirective directive)
	{
