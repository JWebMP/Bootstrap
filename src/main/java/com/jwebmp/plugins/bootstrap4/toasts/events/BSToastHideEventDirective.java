 ...
 * @since 04 Sep 2019
 */
public class BSToastHideEventDirective
		extends AngularDirectiveBase<BSToastHideEventDirective>
{
	 ...
	 */
	public BSToastHideEventDirective()
	{
		super("ngBSToastHideEventDirective");
	}
	...
	{
		return FileTemplates.getFileTemplate(BSToastHideEventDirective.class, "BSToastHideEvent", "BSToastHideEvent.min.js")
		                    .toString();
	}
