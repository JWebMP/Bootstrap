		...
		implements GlobalEvents<J>
{
	 ...
	 */
	private BSCollapseHiddenDirective directive;
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().asAttributeBase().addAttribute("bs-collapse-hidden", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 */
	@NotNull
	public BSCollapseHiddenDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSCollapseHiddenDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSCollapseHiddenDirective directive)
	{
