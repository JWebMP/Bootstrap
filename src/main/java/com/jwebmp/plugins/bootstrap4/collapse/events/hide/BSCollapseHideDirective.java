 ...
 * @since 25 Jun 2016
 */
public class BSCollapseHideDirective
		extends AngularDirectiveBase<BSCollapseHideDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(BSCollapseHideDirective.class, "BSCollapseHide", "BSCollapseHide.min.js")
		                    .toString();
	}
