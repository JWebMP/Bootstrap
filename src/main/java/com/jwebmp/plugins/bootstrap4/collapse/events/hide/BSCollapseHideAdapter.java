		...
		implements GlobalEvents
{
	 ...
	 */
	private BSCollapseHideDirective directive;
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute("bs-collapse-hide", STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 */
	@NotNull
	public BSCollapseHideDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSCollapseHideDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSCollapseHideDirective directive)
	{
