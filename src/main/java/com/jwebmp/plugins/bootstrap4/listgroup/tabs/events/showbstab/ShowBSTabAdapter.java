...
public abstract class ShowBSTabAdapter
		extends Event<GlobalFeatures,ShowBSTabAdapter>
		implements GlobalEvents
{
	 ...
	 */
	public ShowBSTabAdapter(Component component)
	{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().asAttributeBase().addAttribute("show-bs-tab", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
