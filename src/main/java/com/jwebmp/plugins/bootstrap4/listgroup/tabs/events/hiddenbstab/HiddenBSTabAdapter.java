...
public abstract class HiddenBSTabAdapter<J extends HiddenBSTabAdapter<J>>
		extends Event<GlobalFeatures,J>
{
	...
	private static final java.util.logging.Logger LOG = LogFactory.getInstance()
	                                                              .getLogger("HiddenBSTabAdapter");

	/**
	 * The directive for this adapter
	 */
	private HiddenBSTabDirective directive;
	 ...
	 */
	public HiddenBSTabAdapter(Component component)
	{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().asAttributeBase().addAttribute("hidden-bs-tab", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 */
	@NotNull
	public HiddenBSTabDirective getDirective()
	{
		if (directive == null)
		{
			directive = new HiddenBSTabDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(HiddenBSTabDirective directive)
	{
