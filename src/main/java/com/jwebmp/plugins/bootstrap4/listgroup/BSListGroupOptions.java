 ...
 * @author GedMarc
 */
public enum BSListGroupOptions
		implements IBSComponentOptions
{
	 ...
	 * Basic example
	 * <p>
	 * The most basic list group is an unordered list with list items and the proper classes. Build upon it with the options that
	 * follow, or
	 ...
	 * Links and buttons
	 * <p>
	 * Use &lt;a&gt;s or &lt;button&gt;s to create actionable list group items with hover, disabled, and active states by adding
	 * .list-group-item-action. We separate these pseudo-classes to ensure
