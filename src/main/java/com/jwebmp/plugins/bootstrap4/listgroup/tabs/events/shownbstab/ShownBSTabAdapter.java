		...
		implements GlobalEvents
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute("shown-bs-tab", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
