...
public abstract class ShownBSTabAdapter
		extends Event<GlobalFeatures,ShownBSTabAdapter>
		implements GlobalEvents
{
	...
	private static final java.util.logging.Logger LOG = LogFactory.getInstance()
	                                                              .getLogger("ShownBSTab");

	/**
	 * The directive for this adapter
	 */
	private ShownBSTabDirective directive;
	 ...
	 */
	public ShownBSTabAdapter(Component component)
	{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().asAttributeBase().addAttribute("shown-bs-tab", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 */
	@NotNull
	public ShownBSTabDirective getDirective()
	{
		if (directive == null)
		{
			directive = new ShownBSTabDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(ShownBSTabDirective directive)
	{
