 ...
 * @since 3 March 2018
 */
public class BSCardButtonSuccessOutline<J extends BSCardButtonSuccessOutline<J>>
		extends BSCardButton<J>
{
	 ...
	 * @since 16 Feb 2017
	 */
	public BSCardButtonSuccessOutline()
	{
		this(null);
	}
	 ...
	 * @param text
	 */
	public BSCardButtonSuccessOutline(String text)
	{
		super(text);
