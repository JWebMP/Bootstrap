		...
		extends Event<GlobalFeatures, J>
{
	...
	private static final Logger LOG = LogFactory.getInstance()
	                                            .getLogger("BootstrapShownModal");

	private BSModalShownEventDirective directive;
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().asAttributeBase().addAttribute("ng-shown-bootstrap-modal", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	 ...
	 * @return
	 */
	public BSModalShownEventDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSModalShownEventDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSModalShownEventDirective directive)
	{
