		...
		extends Event<GlobalFeatures, J>
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().asAttributeBase().addAttribute("ng-hide-bootstrap-modal", com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	...
	public BSModalHideDirective getDirective()
	{
		if (directive == null)
		{
			directive = new BSModalHideDirective();
		}
		return directive;
	}
	 ...
	 * @param directive
	 */
	public void setDirective(BSModalHideDirective directive)
	{
