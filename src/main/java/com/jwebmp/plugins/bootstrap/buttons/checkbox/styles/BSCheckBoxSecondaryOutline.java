 ...
 * @param <J>
 */
public class BSCheckBoxSecondaryOutline<J extends BSCheckBoxSecondaryOutline<J>>
		extends BSCheckBox<J>
{
	 ...
	 * Note that pre-checked buttons require you to manually add the .active class to the input’s &lt;label&gt;.
	 */
	public BSCheckBoxSecondaryOutline()
	{
		getLabel().addClass(BSButtonOptions.Btn_Outline_Secondary);
	}
}
