package com.jwebmp.plugins.bootstrap.buttons.checkbox.styles;
 ...
 * @param <J>
 */
public class BSCheckBoxWarningOutline<J extends BSCheckBoxWarningOutline<J>>
		extends BSCheckBox<J>
{
	 ...
	 * Note that pre-checked buttons require you to manually add the .active class to the input’s &lt;label&gt;.
	 */
	public BSCheckBoxWarningOutline()
	{
		getLabel().addClass(BSButtonOptions.Btn_Outline_Warning);
	}
}
