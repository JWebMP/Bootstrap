 ...
 * @param <J>
 */
public class BSCheckBoxLightOutline<J extends BSCheckBoxLightOutline<J>>
		extends BSCheckBox<J>
{
	 ...
	 * Note that pre-checked buttons require you to manually add the .active class to the input’s &lt;label&gt;.
	 */
	public BSCheckBoxLightOutline()
	{
		getLabel().addClass(BSButtonOptions.Btn_Outline_Light);
	}
}
