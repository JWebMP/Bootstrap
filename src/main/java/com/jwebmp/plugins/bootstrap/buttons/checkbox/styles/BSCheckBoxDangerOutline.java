 ...
 * @param <J>
 */
public class BSCheckBoxDangerOutline<J extends BSCheckBoxDangerOutline<J>>
		extends BSCheckBox<J>
{
	 ...
	 * Note that pre-checked buttons require you to manually add the .active class to the input’s &lt;label&gt;.
	 */
	public BSCheckBoxDangerOutline()
	{
		getLabel().addClass(BSButtonOptions.Btn_Outline_Danger);
	}
}
