 ...
 * @param <J>
 */
public class BSCheckBoxSuccessOutline<J extends BSCheckBoxSuccessOutline<J>>
		extends BSCheckBox<J>
{
	 ...
	 * Note that pre-checked buttons require you to manually add the .active class to the input’s &lt;label&gt;.
	 */
	public BSCheckBoxSuccessOutline()
	{
		getLabel().addClass(BSButtonOptions.Btn_Outline_Success);
	}
}
