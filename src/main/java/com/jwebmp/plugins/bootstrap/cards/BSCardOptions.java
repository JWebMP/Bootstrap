		...
		implements IBSComponentOptions
{
	...
	Card_Outline_Danger,
	/**
	 * Use card groups to render cards as a single, attached element with equal width and height columns. By default, card groups use
	 * display: table; and table-layout: fixed; to achieve their uniform
	...
	Card_Columns,
	/**
	 * Formats the header section for nav tabs
	 */
	Card_Header_Tabs,
	/**
