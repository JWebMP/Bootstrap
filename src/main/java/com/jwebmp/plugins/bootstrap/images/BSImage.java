        ...
        implements IBSImage<J>
{
     ...
     *
     * @param responsive Value to set for property 'responsive'.
     */
    @Override
     ...
     *
     * @param rounded Value to set for property 'rounded'.
     */
    @Override
    @SuppressWarnings("unchecked")
     ...
     *
     * @param thumbnail Value to set for property 'thumbnail'.
     */
    @Override
    @SuppressWarnings("unchecked")
