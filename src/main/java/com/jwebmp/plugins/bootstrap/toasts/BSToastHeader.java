...
import com.jwebmp.plugins.bootstrap.images.BSImage;

import static com.jwebmp.plugins.bootstrap.options.BSBorderOptions.*;
        ...
        extends DivSimple<J>
{
     ...
     *
     * @param imageIcon Value to set for property 'imageIcon'.
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param closeIcon Value to set for property 'closeIcon'.
     */
    @SuppressWarnings("unchecked")
