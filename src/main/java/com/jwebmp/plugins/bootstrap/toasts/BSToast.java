...
import com.jwebmp.plugins.bootstrap.toasts.features.BSToastFeature;
        ...
        extends DivSimple<J>
{
     ...
     *
     * @param toastHeader Value to set for property 'toastHeader'.
     */
     ...
     *
     * @param toastBody Value to set for property 'toastBody'.
     */
    @SuppressWarnings("unchecked")
