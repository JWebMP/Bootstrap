package za.co.mmagon.jwebswing.plugins.bootstrap.figures;

import za.co.mmagon.jwebswing.base.ComponentHierarchyBase;
import za.co.mmagon.jwebswing.base.html.DivSimple;
import za.co.mmagon.jwebswing.base.html.TableCaption;
import za.co.mmagon.jwebswing.base.servlets.enumarations.ComponentTypes;
import za.co.mmagon.jwebswing.plugins.bootstrap.options.BSTypographyOptions;

import javax.annotation.Nullable;
import javax.validation.constraints.NotNull;

import static za.co.mmagon.jwebswing.plugins.bootstrap.options.BSFigureOptions.Figure_Caption;
import static za.co.mmagon.jwebswing.plugins.bootstrap.options.BSFigureOptions.Figure_Img;
...
public class BSFigure<J extends BSFigure<J>> extends DivSimple<J>
{
	...
	public J setCaption(TableCaption caption, boolean right)
	{
		...
		if (caption != null)
		{
			caption.addClass(Figure_Caption);
			if (right)
			{
