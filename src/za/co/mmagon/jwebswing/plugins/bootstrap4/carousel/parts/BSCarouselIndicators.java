 ...
 */
package za.co.mmagon.jwebswing.plugins.bootstrap4.carousel.parts;
...
import za.co.mmagon.jwebswing.plugins.bootstrap4.carousel.BSCarouselChildren;
import za.co.mmagon.jwebswing.plugins.bootstrap4.carousel.BSCarouselEvents;
import za.co.mmagon.jwebswing.plugins.bootstrap4.carousel.BSCarouselOptions;
	...
	public void init()
	{
		if (!isInitialized() && carousel != null)
		{
			for (int i = 0; i < carousel.getSlides()
			                            .size(); i++)
			{
				BSCarouselIndicatorItem newSlideIndicator = new BSCarouselIndicatorItem(carousel.getID(true), i,
				                                                                        i == carousel.getActiveSlide());
