 ...
 */
package za.co.mmagon.jwebswing.plugins.bootstrap4.dropdown.events.shown;
		...
		extends AngularDirectiveBase
{
	...
	{
		return FileTemplates.getFileTemplate(BSDropDownShownDirective.class, "BSDropDownShown")
		                    .toString();
	}
