...
import za.co.mmagon.jwebswing.plugins.bootstrap4.dropdown.interfaces.BSDropDownEvents;
import za.co.mmagon.jwebswing.plugins.bootstrap4.dropdown.interfaces.IBSDropDown;
...
@ComponentInformation(name = "Bootstrap Dropdown",
		description = "Dropdowns are toggleable, contextual overlays for displaying lists of links and more. They’re made interactive " +
				              "with" + " the included Bootstrap dropdown JavaScript plugin. They’re toggled by clicking, not by hovering;"
