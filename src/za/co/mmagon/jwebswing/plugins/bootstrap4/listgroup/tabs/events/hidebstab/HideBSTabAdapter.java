 ...
 */
package za.co.mmagon.jwebswing.plugins.bootstrap4.listgroup.tabs.events.hidebstab;
		...
		implements GlobalEvents
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute("hide-bs-tab", STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
