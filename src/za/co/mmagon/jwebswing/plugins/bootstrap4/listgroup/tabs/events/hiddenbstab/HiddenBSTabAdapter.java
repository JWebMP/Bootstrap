 ...
 */
package za.co.mmagon.jwebswing.plugins.bootstrap4.listgroup.tabs.events.hiddenbstab;
		...
		implements GlobalEvents
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute("hidden-bs-tab", STRING_ANGULAR_EVENT_START + renderVariables() +
