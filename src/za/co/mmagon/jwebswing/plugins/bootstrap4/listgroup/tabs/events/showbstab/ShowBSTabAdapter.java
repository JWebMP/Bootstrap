 ...
 */
package za.co.mmagon.jwebswing.plugins.bootstrap4.listgroup.tabs.events.showbstab;
		...
		implements GlobalEvents
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute("show-bs-tab", STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
