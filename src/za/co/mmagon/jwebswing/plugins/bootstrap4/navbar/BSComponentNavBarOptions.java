 ...
 * @author GedMarc
 */
public enum BSComponentNavBarOptions
		implements IBSComponentOptions
{
	...
	Navbar,
	/*
	 * Navbars come with built-in support for a handful of sub-components. Choose from the following as needed: <p> .navbar-brand for your
