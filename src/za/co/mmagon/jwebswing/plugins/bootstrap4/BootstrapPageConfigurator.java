...
@PluginInformation(pluginName = "Bootstrap 4",
		pluginDescription = "Bootstrap is the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects "
				                    + "on" + " the web.<br/> We are bootstrap 4 ready!",
		...
		extends PageConfigurator
{
	...
	public Page configure(Page<?> page)
	{
		if (!page.isConfigured())
		{
			...
			viewportMeta.addAttribute(MetaAttributes.Content,
			        ...
			        .compareTo(Browsers.InternetExplorer9) < 1)
			{
				page.getBody()
				    .addJavaScriptReference(
						    new JavascriptReference("html5shim", 1.0, "https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js",
						                            RequirementsPriority.Fourth));
				page.getBody()
				    .addJavaScriptReference(
						    new JavascriptReference("html5shimrespond", 1.0, "https://oss.maxcdn.com/respond/1.4.2/respond.min.js",
						                            RequirementsPriority.Fourth));
			}
