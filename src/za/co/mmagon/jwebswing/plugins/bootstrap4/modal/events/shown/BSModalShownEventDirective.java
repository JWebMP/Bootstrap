 ...
 * @since 25 Jun 2016
 */
public class BSModalShownEventDirective
		extends AngularDirectiveBase
{
	...
	{
		return FileTemplates.getFileTemplate(BSModalShownEventDirective.class, "BSModalShownEvent", "BSModalShownEvent.min.js")
		                    .toString();
	}
